...
run:
	#run docker
	#docker run -p 127.0.0.1:8080:8080 xxxxxx
deploy:
	#deploy
	#aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin some_url.us-east-1.amazonaws.com
